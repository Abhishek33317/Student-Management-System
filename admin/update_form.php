  ...
  <div class="bs-example">
    <form  method="post" enctype="multipart/form-data">
       <div class="form-group">
              <h2>Update Student Details <span class="badge badge-secondary"></span></h2>
...
if(isset($_POST['done'])){
 ...
 $query="UPDATE `student` SET `Id`='$id',`Rollno`='$rollno',`Name`='$name',`City`='$city',`Parents_contact`='$parent_contact_no',`Standard`=' $standard' WHERE `Id`='$id'";
